...
{
    public class extension_excel_builder
    {
        //private attributes 
        ...
        //constructor
        public extension_excel_builder(extension_model_report model, string FileName, EventHandler<notificationmessageEventArgs> notificationmessageEventname)
        {
        ...
        private void AddBodytableHeaders(ref int row, ref int col)
        {
            ...
            col++;
            cellrangeaddr1 = document.IntAlpha(col) + row;
            document.createHeaders(row, col, "DEPARTMENTNAME", cellrangeaddr1, cellrangeaddr1, 0, "WHITE", true, 10, "n");
             
            col++;
            cellrangeaddr1 = document.IntAlpha(col) + row;
            document.createHeaders(row, col, "OWNERASSIGNED", cellrangeaddr1, cellrangeaddr1, 0, "WHITE", true, 10, "n");
             
            col++;
            cellrangeaddr1 = document.IntAlpha(col) + row;
            document.createHeaders(row, col, "EXTENSIONNUMBER", cellrangeaddr1, cellrangeaddr1, 0, "WHITE", true, 10, "n");
        ...
        //table details
        private void AddBodyTableDetail(print_extensions extension_model, ref int row, ref int col)
        {
            ...
            string cellrangeaddr1 = document.IntAlpha(col) + row;
            //document.createHeaders(row, col, extension_model.id, cellrangeaddr1, cellrangeaddr1, 0, "WHITE", true, 10, "n");

            //col++;
            //cellrangeaddr1 = document.IntAlpha(col) + row;
            document.createHeaders(row, col, extension_model.campus_name, cellrangeaddr1, cellrangeaddr1, 0, "WHITE", true, 10, "n");

            col++;
            cellrangeaddr1 = document.IntAlpha(col) + row;
            document.createHeaders(row, col, extension_model.department_name, cellrangeaddr1, cellrangeaddr1, 0, "WHITE", true, 10, "n");

            col++;
            cellrangeaddr1 = document.IntAlpha(col) + row;
            document.createHeaders(row, col, extension_model.owner_assigned, cellrangeaddr1, cellrangeaddr1, 0, "WHITE", true, 10, "n");

            col++;
            cellrangeaddr1 = document.IntAlpha(col) + row;
            document.createHeaders(row, col, extension_model.extension_number, cellrangeaddr1, cellrangeaddr1, 0, "WHITE", true, 10, "n");

            //col++;
            //cellrangeaddr1 = document.IntAlpha(col) + row;
            //document.createHeaders(row, col, extension_model.status, cellrangeaddr1, cellrangeaddr1, 0, "WHITE", true, 10, "n");

            //col++;
            //cellrangeaddr1 = document.IntAlpha(col) + row;
            //document.createHeaders(row, col, extension_model.created_date, cellrangeaddr1, cellrangeaddr1, 0, "WHITE", true, 10, "n");
